...
!(function () {
        ...
        if (1 === s.nodeType) {
          ...
          if (T.test(s.tagName)) {
            ...
            if (e > 0) {
              ...
              for (let i = 0; i < e; i++)
                s.append(t[i], S()), P.nextNode(), a.push({ type: 2, index: ++n });
              s.append(t[e], S());
            }
          }
  ...
  function Y(t, e, i = t, s) {
    ...
    return (
      (null == l ? void 0 : l.constructor) !== d &&
        ...
        void 0 !== s
          ? ((null !== (o = (a = i)._$Co) && void 0 !== o ? o : (a._$Co = []))[s] = l)
          : (i._$Cl = l)),
  ...
  class B {
    ...
    v(t) {
      ...
      const {
        ...
        n = (
          null !== (e = null == t ? void 0 : t.creationScope) && void 0 !== e ? e : A
        ).importNode(i, !0);
      P.currentNode = n;
      let r = P.nextNode(),
        o = 0,
  ...
  class G {
    ...
    _$AI(t, e = this, i, s) {
      ...
      let r = !1;
      if (void 0 === n)
        (t = Y(this, t, e, 0)), (r = !M(t) || (t !== this._$AH && t !== U)), r && (this._$AH = t);
      else {
        const s = t;
        let o, a;
  ...
  const ft = (t) =>
      class extends t {
        ...
        renderCheckable(t, e, i) {
          return z`<label class="checkable-container">${e} <span class="checkable-symbol" role="${t}"></span> ${
            i && i ? z`<span class="checkable-text">${i}</span>` : void 0
          }</label>`;
        }
      },
    mt = 2,
  ...
  const xt = new (class {
    ...
    wt = (i) => {
                  ...
                  null !== (e = this._itemsDataSource) && void 0 !== e
                    ...
                    : await xt.get(
                        ...
                        (t) => {
                          var e;
                          return (
                            (null === (e = t.payload) || void 0 === e ? void 0 : e.event) ===
                            this.dataSource
                          );
                        },
                        i
      ...
      return (
        ...
        t(
          [rt({ attribute: 'hot-reload', type: Boolean }), e('design:type', Object)],
          s.prototype,
          'hotReload',
          void 0
        ),
  ...
  const jt = new WeakMap(),
      ...
      class extends Nt {
        ...
        get lt() {
          ...
          return 'function' == typeof this.Y
            ? null === (e = jt.get(null !== (t = this.dt) && void 0 !== t ? t : globalThis)) ||
              void 0 === e
              ? void 0
              : e.get(this.Y)
    ...
    zt = (i) => {
      class s extends i {
        ...
        renderDelegate(t = (t) => t) {
          ...
          return z`<div class="flex container"><label class="flex-grow" aria-disabled="${
            this.disabled
          }" @click="${() => !this.disabled && this.invoked && this.invoked()}" .title="${
            (null == i ? void 0 : i.toString()) || ''
          }">${t(i)}</label><sdpi-button class="flex-shrink margin-left" ${Tt(
            this.focusElement
          )} .disabled="${this.disabled}" @click="${() =>
            !this.disabled && this.invoked && this.invoked()}"><div>${
            (null === (e = this.label) || void 0 === e ? void 0 : e.toString()) || '...'
          }</div></sdpi-button></div>`;
        }
      }
    ...
    Rt = (i) => {
      class s extends i {
        ...
        renderGrid(t) {
          if (0 !== t.length)
            return z`<div class="gridded-container">${t.map(
              (t) => z`<div class="gridded-item gridded-col-${this.columns}">${t}</div>`
            )}</div>`;
        }
      }
    ...
    use(t, e, i = 250, s = !0) {
      e &&
        this.didReceive.subscribe((i) => {
          var s;
          void 0 !==
            (null === (s = null == i ? void 0 : i.payload) || void 0 === s ? void 0 : s.settings) &&
  ...
  const Wt = new Yt(xt.didReceiveGlobalSettings, (t) => xt.setGlobalSettings(t)),
    ...
    qt = (i) => {
      ...
      return (
        t(
          [rt({ attribute: 'global', type: Boolean }), e('design:type', Object)],
          s.prototype,
          'isGlobal',
          void 0
        ),
  ...
  let Ft = class extends Zt(et) {
    ...
    render() {
      return z`<button .disabled="${this.disabled}" .value="${
        this.value || ''
      }"><slot></slot></button>`;
    }
  };
  ...
  let te = class extends qt(Ot(Zt(et))) {
    ...
    render() {
      var t;
      return z`<input ${Tt(this.focusElement)} type="${this.type}" list="${Jt(
        null === (t = this.dataListController.dataList) || void 0 === t ? void 0 : t.id
      )}" max="${Jt(this.max)}" min="${Jt(this.min)}" step="${Jt(this.step)}" .disabled="${
        this.disabled
      }" .value="${this.value || this.defaultValue || ''}" @change="${(t) =>
        (this.value = t.target.value)}"> ${this.dataListController.dataList}`;
    }
  };
  ...
  let ee = class extends qt(Ot(ft(Zt(et)))) {
    render() {
      ...
      return this.renderCheckable(
        'checkbox',
        z`<input ${Tt(this.focusElement)} type="checkbox" .checked="${
          null !== (e = null !== (t = this.value) && void 0 !== t ? t : this.defaultValue) &&
          void 0 !== e &&
          e
        }" .disabled="${this.disabled}" @change="${(t) => (this.value = t.target.checked)}">`,
        this.label
      );
    }
  };
          ...
          this.renderGrid(
            this.renderDataSource((t) =>
              this.renderCheckable(
                'checkbox',
                z`<input type="checkbox" .checked="${
                  (this.value && this.value.findIndex((e) => e == t.value) > -1) || !1
                }" .disabled="${this.disabled || t.disabled || !1}" .value="${t.value}" @change="${
                  this.handleChange
                }">`,
                t.label
              )
  ...
  let se = class extends qt(Ot(Zt(et))) {
    ...
    render() {
      return z`<input type="color" ${Tt(this.focusElement)} .disabled="${
        this.disabled
      }" .defaultValue="${this.value || this.defaultValue || ''}" @change="${(t) =>
  ...
  let re = class extends zt(qt(Ot(Zt(et)))) {
    ...
    render() {
      ...
      )} <input ${Tt(this.focusElement)} type="file" id="file_input" .accept="${
        this.accept || ''
      }" .disabled="${this.disabled}" @change="${(t) => (this.value = ct(t.target.value))}">`;
    }
    invoked() {
      var t;
  ...
  let ae = class extends qt(Ot(Zt(et))) {
    ...
    render() {
      var t;
      return z`<input ${Tt(this.focusElement)} pattern="${Jt(this.pattern)}" placeholder="${Jt(
        null === (t = this.placeholder) || void 0 === t ? void 0 : t.toString()
      )}" maxlength="${Jt(this.maxLength)}" .disabled="${this.disabled}" .required="${
        this.required
      }" .type="${this.type}" .value="${this.value || ''}" @input="${(t) =>
        (this.value = t.target.value)}">`;
    }
  };
  t(
        ...
        complete: () =>
          this.renderGrid(
            this.renderDataSource((t) =>
              this.renderCheckable(
                'radio',
                z`<input type="radio" name="_" .checked="${
                  this.value == t.value ||
                  (null != this.defaultValue && this.defaultValue == t.value)
                }" .disabled="${this.disabled || t.disabled || !1}" .value="${t.value}" @change="${(
                  t
  ...
  let ce = class extends qt(Ot(Zt(et))) {
    ...
    render() {
      ...
      const i =
          ...
          '',
        s = z`<input ${Tt(this.focusElement)} type="range" max="${Jt(this.max)}" min="${Jt(
          this.min
        )}" step="${Jt(this.step)}" .disabled="${
          this.disabled
        }" .title="${i}" .value="${i}" @change="${(t) => (this.value = t.target.valueAsNumber)}">`;
      return this.showLabels
        ? z`<div class="container"><div aria-disabled="${
            this.disabled
          }" role="button" @click="${() =>
            !this.disabled && void 0 !== this.min && (this.value = this.min)}"><slot name="min">${
            this.min
          }</slot></div><div>${s}</div><div aria-disabled="${
            this.disabled
          }" role="button" @click="${() =>
            !this.disabled && void 0 !== this.max && (this.value = this.max)}"><slot name="max">${
            this.max
          }</slot></div></div>`
        : s;
    }
  ...
  t([rt({ type: Number }), e('design:type', Number)], ce.prototype, 'max', void 0),
    ...
    t(
      [rt({ attribute: 'showlabels', type: Boolean }), e('design:type', Object)],
      ce.prototype,
      'showLabels',
      void 0
    ),
  ...
  let he = class extends et {
    render() {
      return z`<div class="container grid"><div class="label"><label @click="${
        this.handleLabelClick
      }">${
        this.label ? this.label.toString() + ':' : void 0
      }</label></div><div class="content"><slot></slot></div></div>`;
    }
    handleLabelClick() {
  ...
  let be = class extends qt(Ot(wt(Ut(Zt(et))))) {
    ...
    firstUpdated(t) {
      super.firstUpdated(t),
        this.labelSetting &&
          ([this.getLabel, this.setLabel] = Vt(this.labelSetting, null, null, !1));
    }
    render() {
      var t, e;
      const i = this.disabled || this.items.status !== mt,
        s =
          this.getSelectedValueFrom(
            null !== (e = null === (t = this.items) || void 0 === t ? void 0 : t.value) &&
              void 0 !== e
              ? e
              : []
          ) || this.defaultValue,
        n = z`<select ${Tt(this.focusElement)} .disabled="${i}" .value="${
          ...
          complete: () =>
            z`${void 0 === s ? ge(this.getLabelOrPlaceholder()) : void 0} ${this.renderDataSource(
              (t) =>
                z`<option .disabled="${t.disabled || !1}" .value="${t.value}" .selected="${
                  t.value === s
                }">${t.label}</option>`,
              (t, e) => {
                var i;
                return z`<optgroup .label="${
                  (null === (i = t.label) || void 0 === i ? void 0 : i.toString()) || ''
                }">${e}</optgroup>`;
              }
            )}`,
        })}</select>`;
      return this.showRefresh && void 0 !== this.dataSource
        ? z`<div class="flex"><div class="flex-grow">${n}</div><div class="flex-shrink margin-left"><sdpi-button .disabled="${i}" @click="${() =>
            this.refresh()}"><div class="refresh"> </div></sdpi-button></div></div>`
        : n;
    }
  ...
  let ye = class extends qt(Ot(Zt(et))) {
    ...
    static get styles() {
      return [
        ...super.styles,
        Ht,
        a`textarea{background-color:var(--input-bg-color);padding:calc(var(--spacer) + 3px)
        var(--spacer);resize:none}textarea:disabled{opacity:var(--opacity-disabled)}.length{color:var(--font-color);display:block;text-align:right;font-family:var(--font-family);font-size:var(--font-size)}`,
      ];
    }
    render() {
      return z`<textarea ${Tt(this.focusElement)} type="textarea" maxlength="${Jt(
        this.maxLength
      )}" .disabled="${this.disabled}" .id="${this.inputId}" .rows="${this.rows}" .value="${
        this.value || ''
      }" @input="${(t) => (this.value = t.target.value)}"></textarea> ${this.getLengthLabel()}`;
    }
    getLengthLabel() {
      var t;
      if (this.showLength || this.maxLength) {
        const e = this.maxLength ? z`/${this.maxLength}` : void 0;
        return z`<label class="length" for="${this.inputId}">${
  ...
  t(
    ...
    t(
      [rt({ attribute: 'showlength', type: Boolean }), e('design:type', Object)],
      ye.prototype,
      'showLength',
      void 0
    ),
  ...
  ($e.innerHTML = a`
    :root {
      --sdpi-label-color: #969696;
      --sdpi-font-family: "Segoe UI", Arial, Roboto, Helvetica, sans-serif;
      --sdpi-font-size: 9pt;
    }

    body, html {
      background-color: transparent;
      color: var(--sdpi-label-color);
      font-family: var(--sdpi-font-family);
      font-size: var(--sdpi-font-size);
    }

    /* Opt-in class for normal text */
    .normal-text {
      color: var(--sdpi-label-color);
      font-family: var(--sdpi-font-family);
      font-size: var(--sdpi-font-size);
